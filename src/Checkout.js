  ...
  return (
    <div className="product-card">
      ...
      <p className="product-quantity">
        <button disabled={disableAdd} onClick={addProductToCart}>
          Add
        </button>
        Quantity:
        <span>{product.quantity}</span>
        <button disabled={disableRemove} onClick={removeProductFromCart}>
          Remove
        </button>
      </p>
    </div>
  ...
  return (
    <tr key={props.id}>
      ...
      <td>
        ...
        <button disabled={disableAdd} onClick={props.onAdd}>
          +
        </button>
      </td>
